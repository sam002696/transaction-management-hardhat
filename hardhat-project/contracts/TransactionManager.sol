...
contract TransactionManager {
    ...
    event TransactionMade(address indexed sender, address indexed receiver, uint amount);
    ...
    function sendTransaction(address receiver) external payable {
        ...
        Transaction memory newTransaction = Transaction(msg.sender, receiver, msg.value, block.timestamp);
    ...
    function getTransactions(address user) external  returns (Transaction[] memory) {
